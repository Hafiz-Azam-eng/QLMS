         ...
         <Link to={{ pathname: '/Reading', search: `?surahNumber=${para.number}` }}>
           <div className='flex items-center justify-between h-20 border border-gray-200 hover:border-gray-300 drop-shadow-lg'>
               ...
               <div className='flex items-center justify-center origin-center rotate-45 w-10 h-10 ml-5 bg-[#f4f5f6] hover:bg-[#00cc81]'>
                  <span className='origin-center rotate-[-45deg] text-gray-800 hover:text-white'>{para.number}</span>
               </div>
               <div className='flex flex-col'>
               <span className='mr-10'>{para.englishName}</span>
               <span className='mr-10 text-gray-400 font-thin'>{para.englishNameTranslation}</span>
               </div>
               </div>
               <span className='mr-5 font-[CustomFontName]'>{para.name}</span>
           </div>
...
{/* <div className="flex justify-center lg:container mx-10 py-24">
         ...
         <div className='flex flex-wrap mx-20'>
          ...
          <Link to="/Reading">
             <div className='flex items-center justify-between h-20 border border-gray-200 hover:border-gray-300 drop-shadow-lg'>
                 <div className='flex items-center gap-4 '>
                 <div className='flex items-center justify-center origin-center rotate-45 w-10 h-10 ml-5 bg-[#576867]'>
                    <span className='origin-center rotate-[-45deg] text-white'>1</span>
                 </div>
                 <span className='mr-10'>Alfatihah</span>
                 </div>
                 <span className='mr-5 font-[CustomFontName]'>UrduName</span>
             </div>
          </Link>
          </div>
